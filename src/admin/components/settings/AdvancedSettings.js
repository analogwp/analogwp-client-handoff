                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="text-center p-4 bg-white rounded-lg border border-gray-200">
                                <div className="text-lg font-semibold text-gray-900">{window.agwpSnAjax?.pluginVersion || 'Unknown'}</div>
                                <div className="text-sm text-gray-500">{__('Plugin Version', 'analogwp-site-notes')}</div>
                            </div>
                            <div className="text-center p-4 bg-white rounded-lg border border-gray-200">
                                <div className="text-lg font-semibold text-gray-900">{window.agwpSnAjax?.wpVersion || 'Unknown'}</div>
                                <div className="text-sm text-gray-500">{__('WordPress Version', 'analogwp-site-notes')}</div>
                            </div>
                            <div className="text-center p-4 bg-white rounded-lg border border-gray-200">
                                <div className="text-lg font-semibold text-gray-900">{window.agwpSnAjax?.phpVersion || 'Unknown'}</div>
