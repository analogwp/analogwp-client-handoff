...
const AdminSidebar = () => {
    return (
        <div className="sn-w-64 sn-bg-white sn-border-r sn-border-gray-200 sn-flex sn-flex-col sn-h-full">
            <div className="sn-flex sn-items-center sn-px-6 sn-py-4 sn-border-b sn-border-gray-200">
                <div className="sn-flex sn-items-center sn-justify-center sn-w-8 sn-h-8 sn-bg-blue-600 sn-rounded-lg sn-text-white sn-mr-3">
                ...
                <span className="sn-text-lg sn-font-semibold sn-text-gray-900">DashPro</span>
            </div>
            
            <nav className="sn-flex-1 sn-px-4 sn-py-6">
                <ul className="sn-space-y-2">
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-white sn-bg-blue-600 sn-rounded-lg">
                            <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16" className="sn-mr-3">
                            ...
                            {__('Dashboard', 'analogwp-site-notes')}
                        </a>
                    </li>
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-gray-700 hover:sn-bg-gray-100 sn-rounded-lg sn-transition-colors sn-duration-200">
                    ...
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-gray-700 hover:sn-bg-gray-100 sn-rounded-lg sn-transition-colors sn-duration-200">
                            ...
                            {__('Updates', 'analogwp-site-notes')}
                        </a>
                    </li>
                    <li className="sn-my-4">
                        <hr className="sn-border-gray-200" />
                    </li>
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-gray-700 hover:sn-bg-gray-100 sn-rounded-lg sn-transition-colors sn-duration-200">
                            <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16" className="sn-mr-3">
                    ...
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-gray-700 hover:sn-bg-gray-100 sn-rounded-lg sn-transition-colors sn-duration-200">
                            ...
                            {__('Comments', 'analogwp-site-notes')}
                        </a>
                    </li>
                    <li className="sn-my-4">
                        <hr className="sn-border-gray-200" />
                    ...
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-gray-700 hover:sn-bg-gray-100 sn-rounded-lg sn-transition-colors sn-duration-200">
                            ...
                            {__('Elementor', 'analogwp-site-notes')}
                        </a>
                    </li>
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-gray-700 hover:sn-bg-gray-100 sn-rounded-lg sn-transition-colors sn-duration-200">
                            ...
                            {__('Templates', 'analogwp-site-notes')}
                        </a>
                    </li>
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-gray-700 hover:sn-bg-gray-100 sn-rounded-lg sn-transition-colors sn-duration-200">
                            ...
                            {__('Style Kits', 'analogwp-site-notes')}
                        </a>
                    </li>
                    <li className="sn-my-4">
                        <hr className="sn-border-gray-200" />
                    ...
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-gray-700 hover:sn-bg-gray-100 sn-rounded-lg sn-transition-colors sn-duration-200">
                            ...
                            {__('Appearance', 'analogwp-site-notes')}
                        </a>
                    </li>
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-gray-700 hover:sn-bg-gray-100 sn-rounded-lg sn-transition-colors sn-duration-200">
                            ...
                            {__('Plugins', 'analogwp-site-notes')}
                        </a>
                    </li>
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-gray-700 hover:sn-bg-gray-100 sn-rounded-lg sn-transition-colors sn-duration-200">
                    ...
                    <li>
                        <a href="#" className="sn-flex sn-items-center sn-px-3 sn-py-2 sn-text-sm sn-font-medium sn-text-gray-700 hover:sn-bg-gray-100 sn-rounded-lg sn-transition-colors sn-duration-200">
                            ...
                            {__('Collapse menu', 'analogwp-site-notes')}
                        </a>
                    </li>
                </ul>
            </nav>
